...
/**
 * Priceparam entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "priceparam")
public class Priceparam implements java.io.Serializable {
	...
	/** full constructor */
	public Priceparam(String houseIeee, long energyId, long energyFieldId,
			long energyTimeId, String name, double price, double priceDst) {
